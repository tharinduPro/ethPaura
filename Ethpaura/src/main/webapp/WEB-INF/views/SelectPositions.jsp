					...
					<div class="panel panel-default" style="padding: 10px;">
						...
						<div class="panel-body">
							...
							<form:form class="form-horizontal" method="post"
								action="showPositions" commandName="elephantdetail"
								style="margin-right: 20px; margin-top: 5px;">

								<h4>Please Select a date and/or Elephant to retrieve
									position data sets recieved from collars</h4>
								...
								<button type="submit" class="btn">Show Position Data</button>
							...
							<c:if test="${!empty positionList}">
								...
								<table class="table table-hover">
									...
									<c:forEach items="${positionList}" var="po">
										<tr>
											<td><c:out value="${po.date}" /></td>
											<td><c:out value="${po.latitude}" /></td>
											<td><c:out value="${po.logitute}" /></td>
										</tr>
									</c:forEach>
								</table>
							</c:if>

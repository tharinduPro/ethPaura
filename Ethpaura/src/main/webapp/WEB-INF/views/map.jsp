							...
							<link href="<c:url value="/resources/css/style.css"/>"
								...
								<script>
									function myFunction() {
										...
										var e = document.getElementById("elex");
										var strUser = e.options[e.selectedIndex].value;

										var xmlhttp = new XMLHttpRequest();
										var url = "http://localhost:8080/ethpaura-1.0.0-BUILD-SNAPSHOT/MapData/Id/"
												+ strUser;
									...
									function initialize() {
										...
										var xmlhttp = new XMLHttpRequest();
										var url = "http://localhost:8080/ethpaura-1.0.0-BUILD-SNAPSHOT/MapData/Id/2";
				...
				<div class="col-lg-8">
					<div class="panel panel-default" style="padding: 10px;">
						...
						<div>
							...
							<h4>Please select an Elephant to show the last three
								positions and timestamp in the map</h4>

						</div>

						<div>

							<select onchange="myFunction()" name="eid" id="elex"
								class="form-control">

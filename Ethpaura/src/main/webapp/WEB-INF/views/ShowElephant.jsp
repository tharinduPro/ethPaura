				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<a href="${contextPath}/Elephants"><label>Back to
									Elephant List</label></a>

							<h2 align="center">Showing Elephant Details</h2>

							<c:if test="${!empty elephant}">

								<div class="row">
									<div class="col-md-4">

										<img src="<c:url value="/img_resources/${elephant.photo}"/>" width="200"
											class="img-rounded" />
									...
									<div class="col-md-8">
										...
										<div class="control-group">
											<label class="control-label" for="name">${elephant.name}</label>
										</div>

										<div class="control-group">
											<label class="control-label" for="age">${elephant.age}</label>
										</div>


										<div class="control-group">
											<label class="control-label" for="gender">${elephant.gender}</label>
										</div>

										<div class="control-group">
											<label class="control-label" for="habbitat">General Habbitat is ${elephant.habbitat}</label>
										</div>

										<div class="control-group">
											<label class="control-label" for="type">${elephant.type}</label>
										</div>


										<c:if test="${!empty collarId}">

											<div class="control-group">
												<label class="control-label" for="collar">Collar Id
													: ${elephant.collarId}</label>
											</div>

											<div class="control-group">
												<label class="control-label" for="collarDate">Collared
													Date : ${elephant.collaredDate}</label>
											</div>

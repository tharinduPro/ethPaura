					...
					<div class="panel panel-default" style="padding: 10px;">
						...
						<div class="panel-body">
							...
							<form:form class="form-horizontal" method="post"
								action="showPredictions" commandName="elephantdetail"
								style="margin-right: 20px; margin-top: 5px;">

								<h4>Please Select an Elephant to retrieve latest health
									reports analysed based on collar data</h4>
								...
								<button type="submit" class="btn">Show Health Reports</button>
							...
							<c:if test="${!empty PList}">
								...
								<table class="table table-hover">
									...
									<c:forEach items="${PList}" var="pre">
										<tr>
											<td><c:out value="${pre.timestamp}" /></td>
											<td><c:out value="${pre.description}" /></td>

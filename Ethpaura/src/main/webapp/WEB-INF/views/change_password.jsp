							...
							<c:forEach items="${attackEleps}" var="re">
									...
									<li class="left clearfix"><span class="chat-img pull-left">
										<img src="<c:url value="/img_resources/${re.getImage()}"/>"
											alt="User Avatar" class="img-circle" width="80" />
										</span> 
				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form:form name="userForm" method="post" action="changePassword"
								...
								<div class="form-group">
									<div class="fieldWrapper">
										<label for="pass1">Type New Password:</label>
										<form:input path="password2" type="password"
											class="form-control" name="pass1" id="pass1" />
									</div>
								</div>
								...
								<div class="form-group">
									<div class="fieldWrapper">
										...
										<form:input path="password3" type="password"
											class="form-control" name="pass2" id="pass2"

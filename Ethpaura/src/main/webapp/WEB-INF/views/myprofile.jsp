				...
				<div class="panel-body">
					...
					<div class="prof-back-main">
						...
						<div class="prof-back-wall">
							...
							<h3 class="prof-name">${myprofile.fname} ${myprofile.lname}</h3>
							<h4 class="prof-sub">${myprofile.occupation}</h4>

						</div>

						<img src="<c:url value="/img_resources/${myprofile.photo}"/>" width="80" class="img-circle img-responsive prof-left" /> <a href="${contextPath}/editProfile"><h5 class="edit">Edit Profile</h5></a>
							...
							<form class="form-horizontal">
								...
								<c:if test="${!empty myprofile}">
									...
									<div class="control-group">
										<label class="control-label" for="inputBdate">Name</label>
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.fname},${myprofile.lname}</span>
										</div>
									</div>

									<div class="control-group">
										<label class="control-label" for="inputBdate">Gender</label>
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.gender}</span>
										</div>
									</div>


									<div class="control-group">
										<label class="control-label" for="inputBdate">Age</label>
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.age}</span>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.occupation}</span>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.phoneNo}</span>
										</div>
									</div>


									<div class="control-group">
										<label class="control-label" for="inputPhone">Email</label>
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.email}</span>
										</div>
									</div>


									<div class="control-group">
										<label class="control-label" for="inputBiography">Biography</label>
										<div class="controls">
											<span class="input-xlarge uneditable-input">${myprofile.biblography}</span>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class="input-xlarge uneditable-input">${refer}</span>
										</div>
									</div>

					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form:form class="form-horizontal" method="post"
								action="showAttacks" commandName="attacks"
								...
								<div class="form-group">
									...
									<form:select path="vid" name="vid" class="form-control">

										<c:if test="${!empty villageList}">


											<c:forEach items="${villageList}" var="village">
											<label>Select A dsdsd : </label>
							...
							<div>
								<h2 align="center">Attack List</h2>
							</div>

							<legend></legend>


							<c:if test="${!empty attackList}">
								<h3>Showing Attacks</h3>
								<table class="table table-hover">
									...
									<c:forEach items="${attackList}" var="ata">
										<tr>
											<td><c:out value="${ata.date}" /></td>
											<td><c:out value="${ata.time}" /></td>
											<td><c:out value="${ata.casualties}" /></td>
											<td><c:out value="${ata.damages}" /></td>
										</tr>
									</c:forEach>
								</table>
							</c:if>

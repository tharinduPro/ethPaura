...
<!-- /.col-lg-4 -->
        ...
        <form:form class="form-horizontal" method="post" action=""  commandName="">
        
            <div class="row">
                <div class="col-lg-12"><br>
                    <h1 class="page-header">Add Elephant Attack</h1>
                </div>
           ...
           <div class="row">
 			<div class="col-lg-5 col-xs-offset-3">
            		<div class="form-group">
    					<p>Elephant Name</p>
                			<form:input path="" class="form-control" type="text" id="inputName" placeholder="Elephant Name"/>
            ...
            <div class="row">
					<div class="col-lg-5 col-xs-offset-3">
						<div class="form-group">
							<p>Village Name</p>
								<form:input path="" class="form-control" type="text" id="inputName" placeholder="Village Name"/>
    					</div>
    				</div>
   			</div>    
            ...
            <div class="row">
 					<div class="col-lg-5 col-xs-offset-3">
                    	<div class="form-group">
      					...
      					<form:input path=""  class="form-control" type="date" id="inputBdate" placeholder="Date"/>
    					</div>
 					</div>
			</div>
            ...
            <div class="row">
 				<div class="col-lg-5 col-xs-offset-3">
    				<div class="form-group">
      					...
      					<form:input path=""  class="form-control" type="time" id="inputHabbitat" placeholder="Time"/>
    				</div>
  				</div>
  			</div>
 			...
 			<div class="row">
 				<div class="col-lg-5 col-xs-offset-3">
                	<div class="form-group">
                           ...
                           <form:input path="" class="form-control" type="text" id="inputCasualities" placeholder="Casualities"/>
    				</div>
				</div>
 			</div>
		...
		<div class="row">
					<div class="col-lg-5 col-xs-offset-3">
						<div class="form-group">
								<p>Damage</p>
		      					...
		      					<form:input path="" type="text" class="form-control" id="inputDamage" placeholder="Damage"/>
		    			</div>
		   			</div> 
		  </div>   
		    ...
		    <div class="row">
					<div class="col-lg-5 col-xs-offset-3">
						<div class="form-group">
								<p>Method of Handling</p>
		          					<form:input path="" type="text" class="form-control" id="inputMethod of Handling" placeholder="Method of Handling"/>
		    			</div>
		   			</div> 
		   	</div> 
		   ...
		   <div class="row">
		 		<div class="col-lg-5 col-xs-offset-3">
		     					...
		     					<br/>
		                        <p>Report of Incident</p>
		
		
		                        
		                        <form:input path="" type="file" class="filestyle" data-icon="false"/>
		    ...
		    <div class="row">
		 		<div class="col-lg-5 col-xs-offset-3">
		     					...
		     					<br/>
		                        <p>Photos of Incident</p>
		
		
		                        
		                        <form:input path="" type="file" class="filestyle btn btn-default btn-sm" data-icon="false"/>

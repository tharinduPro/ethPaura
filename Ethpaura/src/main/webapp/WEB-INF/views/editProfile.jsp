	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html"> <img
				src="<c:url value="/resources/img/logo.png" />" height="35" />
			</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="prof-back-main">
								...
								<img src="<c:url value="/img_resources/${myprof.photo}"/>"
									width="80" class="img-circle img-responsive prof-left" /> <a
							...
							<ul class="nav" id="side-menu">
								...
								<li><a href="${contextPath}/header" class="list-group-item">
										<i class="fa fa-comment fa-fw"></i>Home

								</a></li>
								<li><a href="#" class="list-group-item"><i
										class="fa fa-eye fa-fw"></i> Elephant Details<span
										class="fa arrow"></span></a>
									<ul class="nav nav-second-level">
										<li><a href="${contextPath}/Elephants"
											class="list-group-item"> Elephant Details </a></li>
										<li><a href="${contextPath}/SelectHealthData"
											class="list-group-item"> Health Data </a></li>

										<li><a href="${contextPath}/DeathIncidents"
											class="list-group-item"> Death Incidents </a></li>
										<li><a href="${contextPath}/HeathInfo"
											class="list-group-item"> Elephant Health Info </a></li>
									</ul> <!-- /.nav-second-level --></li>
								<li><a href="tables.html" class="list-group-item"><i
										class="fa fa-table fa-fw"></i> Attacks <span class="fa arrow"></span></a>
									<ul class="nav nav-second-level">
										<li><a href="${contextPath}/Attacks"
											class="list-group-item"> Recent Attacks </a></li>
										<li><a href="${contextPath}/AttackMap"
											class="list-group-item"> Attack Area Map </a></li>
									</ul></li>

								<li><a href="#" class="list-group-item"><i
										class="fa fa-wrench fa-fw"></i> Position Maps <span
										class="fa arrow"></span></a>
									<ul class="nav nav-second-level">
										<li><a href="${contextPath}/PositionMap"
											class="list-group-item"> Position Maps </a></li>
										<li><a href="${contextPath}/SelectPosition"
											class="list-group-item"> Position Data </a></li>
							...
							<a href="${contextPath}/userProfile"
								class="btn btn-default btn-block">View Profile</a>
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
									...
									<c:forEach items="${attackEleps}" var="re">
										...
										<li class="left clearfix"><span
											class="chat-img pull-left"> <img
												src="<c:url value="/img_resources/${re.getImage()}"/>"
											...
											<div class="chat-body clearfix">
												<div class="header">
													<strong class="primary-font">${re.getName()}</strong> <small
														...
														class="fa fa-clock-o fa-fw"></i> ${re.getDate()}
													</small>
												</div>
				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form:form name="userForm" method="post" action="edit"
								ng-submit="submitForm(userForm.$valid)" commandName="myprof">
								...
								<div class="form-group">
									...
									<form:input path="lname" type="text" name="fname"
										class="form-control" />
								</div>
								...
								<div class="form-group">
									...
									<div class="form-group">
										<!-- PHOTO -->
										<label>Photo</label>
										<form:hidden path="photo" class="form-control" value="${myprof.photo}" />
									</div>
									...
									<div class="form-group">
										...
										<form:input path="phoneNo" type="number" class="form-control" />
									</div>
									...
									<div class="form-group">
										...
										<form:input path="biblography" type="text"
											class="form-control" />
									</div>


									<!-- REFERENCE -->
									<form:hidden path="reference" class="form-control" />
									...
									<!-- POLICY -->
									<form:hidden path="policy" class="form-control" />

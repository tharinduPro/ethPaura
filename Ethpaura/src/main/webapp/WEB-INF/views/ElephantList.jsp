				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<!-- content             -->
							<form:form name="elephant" class="form-horizontal" method="get"
								action="x" commandName="xelephant">

								<div class="row">
									<div class="col-lg-12">
										<br>
											<h1 class="page-header">Select Elephant</h1>
									</div>
								...
								<div class="row">
									...
									<c:forEach items="${elephantList}" var="elep">
										<div class="col-sm-6 col-md-4">
											<div class="thumbnail">
												<a href=" <c:url value="showElephant/${elep.elephantId}"/> "><img
													src="<c:url value="/img_resources/${elep.photo}"/>"></a>
												<div class="caption">
													<p>${elep.name}</p>
													<p>${elep.age}</p>
												</div>
